...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-[#262626] dark:text-white">
      ...
      <div className="w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0">
        {relDoc.map((item, index) => (
          <div
            ...
            className="border border-[#C9D8FF] dark:border-gray-700 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500"
            key={index}
          >
            <img
